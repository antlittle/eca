...
public class eca_list {
	private String eca_list_id; // id号
	...
	private String list_gmt_create;
	private String list_gmt_modified;

	public String getEca_list_id() {
		return eca_list_id;
	}

	public void setEca_list_id(String eca_list_id) {
		this.eca_list_id = eca_list_id;
	}
	...
	public String getList_gmt_create() {
		return list_gmt_create;
	}

	public void setList_gmt_create(String list_gmt_create) {
		this.list_gmt_create = list_gmt_create;
	}

	public String getList_gmt_modified() {
		return list_gmt_modified;
	}

	public void setList_gmt_modified(String list_gmt_modified) {
		this.list_gmt_modified = list_gmt_modified;
	}
